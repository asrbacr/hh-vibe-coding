const apiKey = "8bc4955ccf15385ac316dd009d2f6a37"; // Укажите свой API-ключ OpenWeatherMap
const city = "Moscow";
...
const fetchWeather = async () => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            document.getElementById("weather-info").innerHTML = "<p>Ошибка загрузки данных о погоде!</p>";
        }
    } catch (error) {
        console.error("Ошибка запроса:", error);
        document.getElementById("weather-info").innerHTML = "<p>Ошибка подключения к сервису погоды.</p>";
    }
};
